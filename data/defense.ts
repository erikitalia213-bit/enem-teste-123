...
export const DEFENSE_SCHEMES: DefenseScheme[] = [
  ...
  scheme("df-03", "Cuartos", "Zona", "Intermedio", "spread",
    ...
    { concept: "Cuatro defensores dividen el campo en cuatro carriles verticales.", strengths: ["Casi imposible completar pases profundos.", "Buena contra cuatro verticales."], weaknesses: ["Todo lo corto está disponible.", "Exige buen flag pulling después de la recepción."], when: "Al final de la mitad o del partido cuando el rival necesita un pase largo.", tip: "Si aceptas los pases cortos, retira la flag de inmediato. Cero yardas después de la recepción." }),
  ...
  scheme("df-27", "Ave María Defensiva", "Situacionales", "Principiante", "empty",
    ...
    { concept: "Todos en el fondo, dentro de la zona de anotación. Se permite cualquier pase corto.", strengths: ["Evita el touchdown en la última jugada.", "Muchos defensores para pelear el balón."], weaknesses: ["Pases cortos totalmente libres.", "Solo sirve cuando el reloj está por terminar."], when: "Última jugada de la mitad o del partido.", tip: "Instrucción clave: nadie deja que un receptor pase detrás de él." }),
